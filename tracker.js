...
$("#startTracking_start").live('click', function(){
    ...
    $("#startTracking_status").html("Tracking Login: <strong>" + track_id + "</strong>");
});
...
$("#startTracking_stop").live('click', function(){
  ...
  $("#startTracking_status").html("Stopped tracking (Logoff): <strong>" + track_id + "</strong>");
...
$('#history').live('pageshow', function () {
  ...
  $("#tracks_recorded").html("<strong>" + tracks_recorded + "</strong> Login recorded");
...
console.log("NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNn");
	// Find the track_id of the Login
	var key = $(this).attr("track_id");
console.log("kkkkkkey" + key);
	// Update the Track Info page header to the track_id
	$("#track_info div[data-role=header] h1").text(key);

	// Get all the GPS data for the specific Login
...
//Naveen - debug - start
$("#track_info div[data-role=header] h1").text(total_km_rounded);
//Naveen - debug - end
...
//Naveen - debug - start
$("#track_info div[data-role=header] h1").text(final_time_m);
//Naveen - debug - end
